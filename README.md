...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dsps-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14781&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dsps-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dsps` can be installed with:

```
conda install dsps
```

It is possible to list all of the versions of `dsps` available on your platform with:
